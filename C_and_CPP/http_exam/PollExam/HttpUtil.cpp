...
int HttpUtil::ConnectWithTimeout(const char* strIP, int iPort, int iConnect_Timeout_MS, int iRecv_Timeout_MS) {
...
int HttpUtil::SendDataByPost(int iSockFd, const string& strHttpHeader, const string& strBody) {
...
string HttpUtil::ReceiveData(int iSockFd, int iMaxRetry) {
	string strRecvMesg = "";
	string strBodyMesg = "";
